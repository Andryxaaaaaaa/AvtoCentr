...
public class Osnovnaya extends AppCompatActivity {
    ...
    public String adresclienta;
    public String marshrutclienta;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textView20 = findViewById(R.id.textviewProgress);
        ...
        String value2 = d2.getText().toString().trim();
        String value3 = d3.getText().toString().trim();
        String value4 = d4.getText().toString().trim();
        String value5 = d5.getText().toString().trim();
        String value6 = d6.getText().toString().trim();
        String value7 = d7.getText().toString().trim();
        String value8 = d8.getText().toString().trim();
        String value9 = d9.getText().toString().trim();
        String value10 = d10.getText().toString().trim();
        String value22 = t2.getText().toString().trim();
        String value33 = t3.getText().toString().trim();
        String value44 = t4.getText().toString().trim();
        String value55 = t5.getText().toString().trim();
        String value66 = t6.getText().toString().trim();
        String value77 = t7.getText().toString().trim();
        String value88 = t8.getText().toString().trim();
        String value99 = t9.getText().toString().trim();
        String value11 = t10.getText().toString().trim();
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        ...
                        new DatePickerDialog.OnDateSetListener() {
                            ...
                            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                                ...
                                d3.setText(dayOfMonth + "/" + (monthOfYear + 1) + "/" + year);
                            }
                        },
                        year, month, day);
                // Установите максимальную дату (сегодняшний день)
        ...
        textViewCurrentUserEmail.setOnClickListener(v -> {
            Intent intent = new Intent(Osnovnaya.this, Profile.class);
            ...
            try {
                ...
                button2.setOnClickListener(v -> {
                    if (value2.isEmpty() || value3.isEmpty() || value4.isEmpty() || value5.isEmpty() ||
                        ...
                        // Если хотя бы одно поле пустое, вы можете показать пользователю сообщение об ошибке или принять другие меры
                        ...
                        String message = "Сообщение\n Заявка на Ремонт " + "\n" +
                                ...
                                "Адрес места эксплуатации / места проведения ремонта: " + adresclienta + "\n" +
                                "Маршрут до клиента составляет: " + marshrutclienta + " км" + "\n" +
                ...
                button.setOnClickListener(v -> {
                    if (value2.isEmpty() || value3.isEmpty() || value4.isEmpty() || value5.isEmpty() ||
                        ...
                        String message = "Сообщение\n Заявка на Техническое обслуживание " + "\n" +
                                "ФИО: " + currentUserFIO + "\n" +
                                "Ваша организация: " + t2.getText().toString() + "\n" +
                                "Дата приобретения: " + t3.getText().toString() + "\n" +
                                "№ товарной накладной: " + t4.getText().toString() + "\n" +
                                "Модель техники: " + t5.getText().toString() + "\n" +
                                "Серийный номер техники (VIN): " + t6.getText().toString() + "\n" +
                                ...
                                "Серийный номер двигателя: " + t10.getText().toString() + "\n" +
                                "Адрес места эксплуатации / места проведения ремонта: " + adresclienta + "\n" +
                                "Маршрут до клиента составляет: " + marshrutclienta + " км" + "\n" +
                                "Описание неисправностей (При наличии): " + t12.getText().toString() + "\n";
                ...
                new Handler(Looper.getMainLooper()).post(() ->
                        Toast.makeText(Osnovnaya.this, "Ошибка при чтении почты", Toast.LENGTH_LONG).show());
            }
        }).start();
    }
    ...
    private void sendRemont() {
        ...
        zayavkaData.put("Адрес места эксплуатации",                adresclienta.toString());
        zayavkaData.put("Маршрут,км",                marshrutclienta.toString());
        ...
        db.collection("zayavka")
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(Osnovnaya.this, "Failed to create document in 'userinfo' collection", Toast.LENGTH_LONG).show();
        ...
        try {
            ...
            locationManager.requestSingleUpdate(LocationManager.GPS_PROVIDER, new LocationListener() {
                            ...
                            new Response.Listener<JSONObject>() {
                                ...
                                public void onResponse(JSONObject response) {
                                    try {
                                        ...
                                        RequestQueue requestQueue = Volley.newRequestQueue(Osnovnaya.this);
                ...
                public void onProviderDisabled(String provider) {
                    Toast.makeText(Osnovnaya.this, "Please enable GPS", Toast.LENGTH_SHORT).show();
                }
            }, null);
    ...
    private void processRouteResponse(JSONObject response, String destinationAddress) {
        try {
            ...
            fullAddress = "Адрес места назначения: " + destinationAddress + "\n" + "Расстояние маршрута: " + df.format(distanceKilometers) + " км\n";
            adresclienta = destinationAddress;
            marshrutclienta = df.format(distanceKilometers);
                    ...
                    .addOnSuccessListener(queryDocumentSnapshots -> {
                        for (DocumentSnapshot documentSnapshot : queryDocumentSnapshots) {
                            ...
                            db.collection("map").document(documentId).update(mapData)
                                    .addOnFailureListener(e -> Toast.makeText(Osnovnaya.this, "Не удалось обновить данные, попробуйте еще раз", Toast.LENGTH_LONG).show());
